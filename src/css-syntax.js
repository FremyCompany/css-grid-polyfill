...
cssSyntax.IdentToken = IdentToken;
...
AtRule.prototype.toStylesheet = function() {
	...
	if(this.asStylesheet) { 
		
		// extract rules out of the media block
		var nestedContent = value;
		if(nestedContent instanceof cssSyntax.SimpleBlock) { 
			this.asStylesheet = parse(nestedContent.value);
		} else {
			this.asStylesheet = new TokenList();
		}
		
	}
	
	// return from the cache
	return this.asStylesheet;
...
cssSyntax.QualifiedRule = QualifiedRule;
